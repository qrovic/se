                                        ...
                                        <div class="modal-dialog menumodal">
                                            <div class="modal-content menumodalcontent">
                                                ...
                                                <div class="modal-footer modalfooter">
                                                    <div>
                                                        <button onclick="decreaseValue()" type="button">-</button>
                                                        <input type="number" id="quantityInput" name="quantity" value="1" min="1" max="100">
                                                        <button onclick="increaseValue()" type="button">+</button>
                                                    </div>
