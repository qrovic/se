            ...
            ?>  
                ...
                <p class="itemdetailstxt">Item Details</p>
                    ...
                    <div class="addstoreinput additeminput">
                        ...
                        <input class="form-control" type="text" id="itemname" name="itemname" id="" value="<?php echo $edititems['name'];?>">
                    </div>
                    <div class="addstoreinput additeminput">
                        <label class="form-label" for="itemcategory">Category:</label>
                        <select class="form-control" name="itemcategory" id="itemcategory">
                            <option <?php if ($edititems['permcategory']=='Drinks'){ echo 'selected';}?> value="Drinks">Drinks</option>
                            <option <?php if ($edititems['permcategory']=='Meals'){ echo 'selected';}?> value="Meals">Meals</option>
                            <option <?php if ($edititems['permcategory']=='Snacks'){ echo 'selected';}?>value="Snacks">Snacks</option>
                            <option <?php if ($edititems['permcategory']=='Desserts'){ echo 'selected';}?>value="Desserts">Desserts</option>
